...
public class Zoo {
    ...
    private void setTestData(){
        zooDB.add(new Cat(10.3, 7.1, 0x1b612f, "Барсик", "Британец", false, new Date(120, 9, 30), 0xdb35d6));
        zooDB.add(new Cat(15.7, 4.8, 0x7468f7, "Муська", "Сфинкс", true, new Date(114, 1, 25)));
        zooDB.add(new Tiger(81.7, 60.4, 0xFF0000, "Барон", new Date(110, 11, 2)));
        zooDB.add(new Dog(24.4, 12.3, 0x5c4f1c, "Шарик", "Дворняга", true, 0x12e012,new Date(118, 3, 12), false));
